...
export const getPendingHoldMinutes = (): number => parsePositiveInt(process.env.BOOKING_PENDING_HOLD_MINUTES, 15);
export const WORK_DAY_START_MINUTES = 9 * 60;
export const WORK_DAY_END_MINUTES = 18 * 60;
export const SLOT_INTERVAL_MINUTES = 30;

export const activeAppointmentStatusSql = (paramRef: string, alias = ''): string => {
