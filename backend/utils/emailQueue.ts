...
type EmailJobType = 'bookingConfirmation' | 'rescheduleConfirmation' | 'cancellationConfirmation';

const emailHandlers: Record<EmailJobType, (appointment: EmailAppointmentDetails) => Promise<void>> = {
...
export const enqueueEmailJob = (type: EmailJobType, appointment: EmailAppointmentDetails): Promise<void> => {
