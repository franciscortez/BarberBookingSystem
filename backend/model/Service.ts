...
export const getServicesByBarber = async (barberId: string): Promise<ServiceWithBarber[]> => {
    const rows = await db.select({
        id: services.id,
        barber_id: services.barber_id,
        name: services.name,
...
export const createService = async (serviceData: CreateServiceInput): Promise<Service> => {
...
export const updateService = async (serviceId: string, serviceData: UpdateServiceInput): Promise<Service | null> => {
