 ...
 * @param {CreatePaymentInput} paymentData 
 * @returns {Promise<Payment>} Created payment
 */
export const createPayment = async (paymentData: CreatePaymentInput, client: any = pool): Promise<Payment> => {
 ...
 */
export const getPaymentById = async (id: string, client: any = pool, forUpdate = false): Promise<Payment | null> => {
    const tx = getDb(client);
 ...
 * @returns {Promise<Payment|null>}
 */
export const getPaymentByCheckoutId = async (checkoutId: string, client: any = pool, forUpdate = false): Promise<Payment | null> => {
    const tx = getDb(client);
 ...
 * @returns {Promise<Payment|null>}
 */
export const updatePayment = async (id: string, updateData: UpdatePaymentInput, client: any = pool): Promise<Payment | null> => {
    const tx = getDb(client);
 ...
 * @returns {Promise<Payment|null>}
 */
export const getPaymentByIdempotencyKey = async (idempotencyKey: string): Promise<Payment | null> => {
