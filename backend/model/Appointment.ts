...
import { Appointment, AppointmentDetails, CreateAppointmentInput, RescheduleScheduleInput } from '../types';
 ...
 */
export const createAppointment = async (appointmentData: CreateAppointmentInput, client: any = pool): Promise<Appointment> => {
 ...
 */
export const getAppointmentById = async (id: string, client: any = pool, forUpdate = false): Promise<Appointment | null> => {
    const tx = getDb(client);
 ...
 * @returns {Promise<Appointment|null>}
 */
export const getAppointmentByManagementToken = async (token: string, client: any = pool, forUpdate = false): Promise<Appointment | null> => {
    const tx = getDb(client);
 ...
 * @returns {Promise<Appointment|null>}
 */
export const updateAppointmentStatus = async (id: string, status: string, client: any = pool): Promise<Appointment | null> => {
    const tx = getDb(client);
 ...
 * @returns {Promise<Appointment|null>}
 */
export const updateAppointmentSchedule = async (id: string, scheduleData: RescheduleScheduleInput, client: any = pool): Promise<Appointment | null> => {
    const tx = getDb(client);
 ...
 */
export const lockBarber = async (barberId: string, client: any): Promise<void> => {
    const tx = getDb(client);
 ...
 */
export const getAppointmentDetails = async (id: string): Promise<AppointmentDetails | null> => {
