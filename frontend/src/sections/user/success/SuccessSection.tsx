...
const SuccessSection: React.FC<SuccessSectionProps> = ({
      ...
      <div className="min-h-screen bg-zinc-950 text-zinc-100 font-sans flex items-center justify-center pt-28 pb-16 px-6">
        <div className="max-w-md w-full rounded-2xl border border-zinc-800 bg-zinc-900/30 backdrop-blur-md p-8 text-center space-y-5">
          ...
          <p className="text-zinc-400 text-sm leading-relaxed">
            We couldn't find a pending booking session. If you've already
            completed payment, check your email for your confirmation and
            management links.
          </p>
          <Link
            to="/"
    ...
    return (
      <div className="min-h-screen bg-zinc-950 text-zinc-100 font-sans flex items-center justify-center pt-28 pb-16 px-6">
        <div className="max-w-md w-full rounded-2xl border border-amber-500/20 bg-zinc-900/30 backdrop-blur-md p-8 text-center space-y-5">
          ...
          <p className="text-zinc-400 text-sm leading-relaxed">
            Your payment may still be processing. Check your email shortly —
            we'll send a confirmation once your booking is secured.
          </p>
  ...
  if (!verified) {
    return (
      <div className="min-h-screen bg-zinc-950 text-zinc-100 font-sans flex items-center justify-center pt-24 sm:pt-28 pb-16 px-4 sm:px-6 relative overflow-hidden">
        ...
        <div className="max-w-xl w-full rounded-2xl border border-zinc-800 bg-zinc-900/30 backdrop-blur-md p-10 text-center space-y-6">
          ...
          <p className="text-zinc-400 text-sm max-w-sm mx-auto leading-relaxed">
            Connecting with PayMongo to confirm your downpayment. This usually
            takes a few seconds.
          </p>
    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100 font-sans flex items-center justify-center pt-24 sm:pt-28 pb-16 px-4 sm:px-6 selection:bg-amber-500/30 selection:text-amber-200 relative overflow-hidden">
      ...
      <div className="max-w-xl w-full rounded-2xl border border-zinc-800 bg-zinc-900/30 backdrop-blur-md p-8 md:p-10 text-center relative overflow-hidden">
        ...
        <p className="text-zinc-400 text-sm max-w-md mx-auto leading-relaxed mt-3">
          Your downpayment has been verified and your appointment slot has been
          secured.
        </p>
        ...
        <div className="rounded-xl border border-zinc-800 bg-zinc-950 p-5 text-left space-y-3.5 my-8">
          <div className="border-b border-zinc-900 pb-2 flex justify-between items-center text-xs font-semibold text-zinc-500 uppercase tracking-wider">
            ...
            <span className="text-amber-400 normal-case font-bold">
              Confirmed
            </span>
          </div>
          <div className="grid grid-cols-2 gap-y-2.5 text-sm">
            ...
            <span className="text-zinc-200 font-medium break-all">
              {appointment?.payment_reference_number ?? "—"}
            </span>
        ...
        <div className="p-4 rounded-xl border border-amber-500/20 bg-amber-500/5 text-left flex gap-3.5 items-start mb-8">
          ...
          <div>
            <h4 className="text-xs font-bold text-white uppercase tracking-wider">
              Secure Management Links Sent
            </h4>
            <p className="text-[11px] text-zinc-400 leading-relaxed mt-1">
              A confirmation email with Reschedule and Cancel links has been
              sent to{" "}
