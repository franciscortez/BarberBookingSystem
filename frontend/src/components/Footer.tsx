...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative mt-auto border-t border-zinc-900 bg-zinc-950/80 backdrop-blur-md overflow-hidden">
      {/* Background glow */}
      <div className="absolute bottom-0 right-1/4 translate-y-1/2 w-full max-w-[400px] h-[400px] bg-amber-500/5 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-12 sm:pt-16 pb-8 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-10 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-zinc-400 leading-relaxed pr-4">
              A premium grooming sanctuary dedicated to classic cuts,
              architectural fades, and traditional straight razor shaves.
              Redefining standards for the modern man.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm text-zinc-400">
              <li className="flex items-start gap-2.5">
                ...
                <span>
                  123 Premium Grooming Blvd, Suite 101, Metro Manila,
                  Philippines
                </span>
              </li>
              ...
              <li className="flex items-center gap-2.5">
                ...
                <a
                  href="mailto:appointments@gentlemensquarters.com"
                  className="hover:text-white transition-colors"
                >
                  appointments@gentlemensquarters.com
                </a>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-2.5 text-sm text-zinc-400">
              <Link
                to="/"
                onClick={handleHomeClick}
                className="hover:text-white hover:underline decoration-amber-400/50 transition-colors inline-flex items-center gap-1"
              >
        ...
        <div className="border-t border-zinc-900 pt-8 mt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-zinc-500 gap-4">
          <p>
            © {new Date().getFullYear()} Gentlemen's Quarters Co. All rights
            reserved.
          </p>
